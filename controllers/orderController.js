  ...
  return `
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>Thank you for choosing MANO Crackers for your festive celebrations!</p>
        
        <p>Best regards,<br>
        <strong>MANO Crackers Team</strong><br>
        Sivakasi - 626123</p>
      </div>
...
const sendReceiptEmail = async (customerEmail, customerName, orderId, pdfBase64, orderData) => {
  try {
    ...
    const mailOptions = {
      from: {
        name: 'MANO Crackers',
        address: process.env.EMAIL_USER || 'mks_prithi@yahoo.co.in'
      },
      to: customerEmail,
      subject: `🎆 Order Confirmation - ${orderId} - MANO Crackers`,
      html: htmlTemplate,
      attachments: [
        {
    ...
    const htmlTemplate = `
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>Thank you for choosing MANO Crackers!</p>
          <p>Best regards,<br><strong>MANO Crackers Team</strong></p>
        </div>
      </body>
      </html>
    `;
